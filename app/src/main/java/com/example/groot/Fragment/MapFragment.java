...
public class MapFragment extends Fragment implements OnMapReadyCallback, PlacesListener {
    ...
    List<Marker> previous_marker = null; // PlacesListener Marker
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                showPlaceInformation(currentPosition);  // 꽃집 표시
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(this)
                .key("AIzaSyAh4eMKlt7jaGhYhpQ61NIW_uG-eho0BTI")
